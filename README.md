...
1. 1st: Find poses between images using 2D-2D correspondences via Essential Matrix
2. 2nd: Find poses between image and 3D model using 2D-3D correspondences via Pnp + RANSAC (This approach is used in our solution)
3. 3rd: Find poses between 2 3D models using 3D -3D correspondences - via ICP (Dreg-Nerf and Nerf2Nerf apply this method)
