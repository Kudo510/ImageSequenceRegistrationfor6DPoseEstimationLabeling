...
def estimate_pose(mask_lgts: torch.tensor, query_img: torch.tensor,
                  ...
                  avg_queries=True, do_prune=True, visualize=False, poses=None, debug=False, returnPoints=False):
    """
    ...
    if poses is None:
        ...
        if True:
            ...
            if do_prune:
                ...
                p3dCp = p3d[dist_2d_mask & size_mask & normals_mask]
                p2dCp = p2d[dist_2d_mask & size_mask & normals_mask]
    ...
    if returnPoints:
        return R, t, pose_scores, mask_scores, coord_scores, dist_2d, size_mask, normals_mask, p3dCp,p2dCp
    else:
